...
{
    /// <inheritdoc />
    public partial class migracionesConSemillas : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Admin",
                columns: new[] { "admin_id", "IdentityUserId", "is_active", "name_admin" },
                values: new object[] { new Guid("11111111-1111-1111-1111-111111111112"), "99999999-9999-9999-9999-999999999991", 1, "Simon" });
