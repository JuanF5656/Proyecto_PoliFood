        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    name_admin = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    is_active = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Student_AspNetUsers_IdentityUserId",
                        column: x => x.IdentityUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vendor_AspNetUsers_IdentityUserId",
                        column: x => x.IdentityUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Vendor_Store_store_id",
                        column: x => x.store_id,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "11111111-1111-1111-1111-111111111111", "a1a1a1a1-1111-1111-1111-111111111111", "Admin", "ADMIN" },
                    { "22222222-2222-2222-2222-222222222222", "b2b2b2b2-2222-2222-2222-222222222222", "Student", "STUDENT" },
                    { "33333333-3333-3333-3333-333333333333", "c3c3c3c3-3333-3333-3333-333333333333", "Vendor", "VENDOR" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Student_IdentityUserId",
                table: "Student",
                column: "IdentityUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Vendor_IdentityUserId",
                table: "Vendor",
                column: "IdentityUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Vendor_store_id",
                table: "Vendor",
                column: "store_id");
        }
